 ...
 * Author: alexcon
 *
 * Created on 13 Октябрь 2016 г., 15:31
 * libdaemon implementation daemon
 * http://web.mit.edu/ghudson/dev/99/third/libdaemon/doc/reference/html/testd_8c-example.html
 */
...
static net::ZMQServer* srv = nullptr;
...
int start_srv() {
    std::string endpoint_local("tcp://127.0.0.1:3333");
    srv = new net::ZMQServer(endpoint_local);
    return 0;
}
void stop_srv(){
